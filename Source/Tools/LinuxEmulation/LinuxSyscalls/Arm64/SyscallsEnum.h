...
// Generated by gen_syscalls_enum.py from Linux 7.2.6
// include/uapi/asm-generic/unistd.h (arm64 64-bit view, cross-checked against
// arch/arm64/tools/syscall_64.tbl). Do not edit by hand.
#pragma once
...
enum Syscalls_Arm64 {
  ...
  SYSCALL_Arm64_open_tree_attr = 467,
  SYSCALL_Arm64_file_getattr = 468,
  SYSCALL_Arm64_file_setattr = 469,
  SYSCALL_Arm64_listns = 470,
  SYSCALL_Arm64_rseq_slice_yield = 471,
  SYSCALL_Arm64_MAX = 472,
};
} // namespace FEX::HLE::Arm64
