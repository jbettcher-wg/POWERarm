...
corpus="hello printf_float strmem fpmath lse lseminmax lsecasp litmus nosve cntvct madvfile vdso vdso_syscalls hlt thunk_callback hoststack procdirfd dcmaint forkexec"
for t in $corpus; do
